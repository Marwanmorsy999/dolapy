const CACHE='dolapy-pwa-v1';
const APP_SHELL=['/','/index.html','/styles.css','/ai.css','/settings.css','/app.js','/ai-overlay.js','/mobile-menu.js','/settings.js','/preload.js','/migrate.js','/manifest.webmanifest','/icon.svg'];
